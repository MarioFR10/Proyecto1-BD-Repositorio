...
DELETE FROM [dbo].[AdminQueryA]
DBCC CHECKIDENT([AdminQueryA], RESEED, 0)
SELECT * FROM [dbo].[AdminQueryA]

DELETE FROM [dbo].[Mov CO Interest]
DBCC CHECKIDENT([Mov CO Interest], RESEED, 0)
