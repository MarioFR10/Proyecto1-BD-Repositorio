	...
	WHILE @lo1 <= @hi1
		BEGIN
			...
			INSERT INTO [dbo].[SavingsAccount](TypeSavingsAccountId, 
											   ...
											   CreationDate, 
											   AccountNumber)
			VALUES (@tipocuenta, @personaId, @saldo, @fechacreacion, @numerocuenta)
...
BEGIN
	...
	WHILE @lo2 <= @hi2
		BEGIN 
			...
			VALUES (@parentezcoId, @benefactorId, @cuentaId, @name, @percentaje, 0)
	...
	WHILE @lo3 <= @hi3
		BEGIN
			...
			INSERT INTO [dbo].[AccountStatement] (SavingsAccountId, 
												  ...
												  InitialBalance, 
												  FinalBalance)
			VALUES ( @estadoCuentaId, @fechaIn, @fechafi, @balanceInicial, @balanceFinal)
